...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-xl border border-border",
        "bg-input-background px-4 py-2 text-sm text-foreground",
        ...
        "dark:bg-input dark:hover:bg-input/80",
