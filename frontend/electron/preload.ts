...
contextBridge.exposeInMainWorld('electron', {
    ...
    backend: {
        ...
        submitVote: (signalId: number, userId: string, selectedOption: string, defaultResponse?: string, reason?: string) =>
            ipcRenderer.invoke('backend-submit-vote', { signalId, userId, selectedOption, defaultResponse, reason }),
